...
<div id="default-carousel" className="relative w-full" data-carousel="slide">
    ...
    <div className="relative overflow-hidden h-[450px]">
        ...
        <div className="relative hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <img src="https://drive.google.com/uc?export=view&id=1tTUJtDym9fP0M3JfED8m_uORBEh1cY8V" 
        ...
        <div className="relative hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://drive.google.com/uc?export=view&id=1gZUKTf8LTTVtxMzOE2d6JCVPDah8-BTS" 
            className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" 
        ...
        <div className="relative hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://drive.google.com/uc?export=view&id=1p5EzBMfv9TjWZ2uBKBplDojZuctEMn-S" 
            className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" 
        ...
        <div className="relative hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://drive.google.com/uc?export=view&id=1oitI1d-d77PBsC1VxQUG8cb5FYv75n9n" 
            className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" 
        ...
        <div className="relative hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://drive.google.com/uc?export=view&id=1u_1Dc-EBSFvA4-GtFSOzuy8jC6u4zoOW" 
